...
export default function ElegantEditorialHero({ intro, stories, onOpenStory, onOpenIntro, onOpenDiscovery }: Props) {
  return (
    <section className="elegant-editorial-hero" aria-labelledby="elegant-editorial-title">
      <div className="elegant-editorial-intro">
        ...
        {intro.ctaLabel?.trim() ? <button type="button" onClick={onOpenIntro}>{intro.ctaLabel}</button> : null}
      </div>
