...
| الحزمة | WP 5.27.2C |
| الحالة | التنفيذ والاختبارات والبناء والاعتماد البصري مكتملة؛ قيد الإغلاق عبر Commit وDraft PR |
...
اعتمد المالك صور سطح المكتب والجوال، وتصبح خطوات الإغلاق:

1. إنشاء Commit للحزمة.
2. Push إلى فرع العمل.
3. فتح Draft PR مستقل إلى `main`.
4. تشغيل البوابات وعدم الدمج حتى موافقة المالك النهائية.
